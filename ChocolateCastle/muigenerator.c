	...
	if (obj = (Object*)DoSuperMethodA(cl, obj, (Msg)msg))
	{
		...
		if (my_group = create_my_group(obj, d))
		{
			...
			if (parent)
			{
				...
				SetAttrs(obj, MUIA_Window_Title, (IPTR)LS(MSG_MUI_GENERATOR_WINDOW_TITLE, "MUI Custom Class"), TAG_END);
				DoMethod(d->SuperclassTypeRadio, MUIM_Notify, MUIA_Radio_Active, MUIV_EveryTime, (intptr_t)d->SuperclassPageGroup, 3, MUIM_Set, MUIA_Group_ActivePage, MUIV_TriggerValue);
