...
DEFNEW
{
	...
	#ifdef __amigaos4__
	MUIA_Window_ScreenTitle,  PROGNAME " " VERSION "." REVISION " ("VERSIONDATE ") 2009-2015 by Michal Wozniak",
	#endif 
...
DEFMMETHOD(VPDFWindow_CreateTab)
{
    ...
    DoMethod(data->grpTitles, MUIM_Family_AddTail, VPDFTitleButtonObject,
			 ...
			 #ifdef __amigaos4__
			 // seems mos's mui handle MUIA_Text_SetMin, TRUE internally
			 MUIA_Text_SetMin, FALSE,
			 // that one just for forcing centered alignment. But this is enforced by Title class already anyway.
...
{ 
    ...
    Object *group = (Object*)DoMethod(data->grpRoot, MUIM_Family_GetChild, tabind + 1); /* +1 for title object */
