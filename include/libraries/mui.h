...
** Copyright (C) 2006-2017 by Thore Boeckelmann, Jens Maus
**
** Main Header File
**
****************************************************************************
...
struct  MUIP_Application_ShowHelp           { ULONG MethodID; Object *window; STRPTR name; STRPTR node; LONG line; };
...
#define MUIA_Textdata_Contents              0x80420c3f /* V21 i.g APTR              */
